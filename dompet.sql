...
ALTER TABLE `kategori` ADD `id_user` INT NOT NULL AFTER `id_kategori`, ADD INDEX (`id_user`); 
ALTER TABLE `transaksi` ADD `uraian` VARCHAR(255) NOT NULL AFTER `id_transaksi`; 
ALTER TABLE `kategori` ADD FOREIGN KEY (`id_user`) REFERENCES `user`(`id_user`) ON DELETE RESTRICT ON UPDATE RESTRICT; 